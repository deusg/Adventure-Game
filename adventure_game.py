...
print('map(m), flashlight(f), chocolate(c), roper(r), sticks(s): ')
...
while not (choice1 == 'y' or choice1 == 'n'):
    choice1 = input('That is an invalid inout. Enter y or n: ')
if choice1 == 'y':
    ...
    if direction == 'north':
        ...
        if item == "m":
            print('You can use the map and find your way home.')
        ...
        if item == "r" or item == 's':
            print('You chose an item that fix the bridge.')
        ...
        if item == 'f':
            ...
            print('A car stops and give youa ride home.')
            print('CONGRATULATIONS! You won the game.')
        else:
    ...
    print('You start working back to the starting point')
    ...
    if answer.lower() == 'python':
        ...
        if item == 'c':
            ...
            print('You give her the cholocate.')
